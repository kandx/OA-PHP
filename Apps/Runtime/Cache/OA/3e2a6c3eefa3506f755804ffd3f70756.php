...
<html lang="zh-CN">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="<?php echo STATIC_PATH;?>/css/ace.min.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="<?php echo STATIC_PATH;?>/css/ace-part2.min.css" />
		<![endif]-->
		<link rel="stylesheet" href="<?php echo STATIC_PATH;?>/css/ace-rtl.min.css" />

		<!--[if lte IE 9]>
		  <link rel="stylesheet" href="<?php echo STATIC_PATH;?>/css/ace-ie.min.css" />
		<![endif]-->
		<link rel="stylesheet" href="<?php echo STATIC_PATH;?>/css/ace.onpage-help.css" />

		<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->

		<!--[if lt IE 9]>
		<script src="<?php echo STATIC_PATH;?>/js/html5shiv.js"></script>
		<script src="<?php echo STATIC_PATH;?>/js/respond.min.js"></script>
		<![endif]-->
	</head>
	...
	<body class="login-layout blur-login">
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="light-blue" id="id-company-text">&copy; 广州市天河中央商务区管理委员会</h4>
							</div>
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='<?php echo STATIC_PATH;?>/js/jquery.min.js'>"+"<"+"/script>");
		</script>
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='<?php echo STATIC_PATH;?>/js/jquery1x.min.js'>"+"<"+"/script>");
</script>
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='<?php echo STATIC_PATH;?>/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
