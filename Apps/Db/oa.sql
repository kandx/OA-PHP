...
--
-- Host: localhost
-- Generation Time: 2015-04-09 11:21:14
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `oa_files` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='文件表' AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `oa_meeting` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='会议情况表' AUTO_INCREMENT=18 ;
...
CREATE TABLE IF NOT EXISTS `oa_reception` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='接待表' AUTO_INCREMENT=21 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='房间预订表' AUTO_INCREMENT=27 ;
...
CREATE TABLE IF NOT EXISTS `oa_schedule` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='日程表' AUTO_INCREMENT=68 ;
...
(9, 'quanxm', '81dc9bdb52d04dc20036dbd8313ed055', '全', '小敏', 'F', '1980-01-01', '1985-01-01', '2011-03-22', 'quanxm@qq.com', '/public', '2015-02-13 16:58:23', 15, '#FF99FF', 0, 1, 0, 3, 4, 3, '2014-12-04 10:37:21', '2014-12-26 16:25:08'),
...
CREATE TABLE IF NOT EXISTS `oa_viewplace` (
  ...
  `name` varchar(10) NOT NULL COMMENT '名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='参观地点' AUTO_INCREMENT=18 ;
...
-- 限制表 `oa_files_user`
--
ALTER TABLE `oa_files_user`
  ADD CONSTRAINT `oa_files_user_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `oa_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `oa_files_user_ibfk_1` FOREIGN KEY (`file_id`) REFERENCES `oa_files` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
